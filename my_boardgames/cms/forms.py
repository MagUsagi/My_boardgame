...
class HistoryForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'duaration': forms.TextInput( attrs={'class': 'form-control', 'aria-label': 'duaration', 'aria-describedby': 'duaration'})#,
            #'player': forms.Select( attrs={'class': 'form-select', 'aria-label': 'player', 'aria-describedby': 'player'}),
            #'score': forms.IntegerField( attrs={'class': 'form-control', 'aria-label': 'score', 'aria-describedby': 'score'}),
            #'winner': forms.BooleanField( attrs={'class': 'form-check-input', 'aria-label': 'winner', 'id': 'winner'}) 
        }
